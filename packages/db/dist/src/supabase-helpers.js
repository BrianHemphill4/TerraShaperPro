...
exports.getOrganizationStorageUsage = getOrganizationStorageUsage;
exports.createProject = createProject;
const supabase_1 = require("./supabase");
/**
 * Upload a file to Supabase Storage
 */
function uploadFile(bucket, path, file, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data, error } = yield supabase_1.supabase.storage.from(bucket).upload(path, file, {
        ...
        const { data: urlData } = supabase_1.supabase.storage.from(bucket).getPublicUrl(path);
        return {
            data: {
                path: data.path,
 ...
 */
function getSignedUrl(bucket_1, path_1) {
    return __awaiter(this, arguments, void 0, function* (bucket, path, expiresIn = 3600) {
        const { data, error } = yield supabase_1.supabase.storage.from(bucket).createSignedUrl(path, expiresIn);
        if (error) {
            return { error: new Error(error.message) };
        }
 ...
 */
function deleteFile(bucket, paths) {
    return __awaiter(this, void 0, void 0, function* () {
        const { error } = yield supabase_1.supabase.storage.from(bucket).remove(paths);
        if (error) {
            return { error: new Error(error.message) };
        }
        return {};
 ...
 */
function listFiles(bucket, folder, options) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function checkPermission(_userId, _resource, _resourceId, _action) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function getOrganizationStorageUsage(organizationId) {
    return __awaiter(this, void 0, void 0, function* () {
        const adminClient = (0, supabase_1.createAdminClient)();
        let totalBytes = 0;
        let fileCount = 0;
 ...
 */
function createProject(client, project) {
    return __awaiter(this, void 0, void 0, function* () {
