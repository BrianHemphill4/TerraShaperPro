...
declare function createRenderWorker(
...
declare function canUserSubmitRender(
  userId: string,
  subscriptionTier: 'starter' | 'pro' | 'growth'
): Promise<{
  allowed: boolean;
