...
declare class UploadUtils {
     ...
     */
    static validateImageFile(contentType: string, maxSizeMB?: number): {
        valid: boolean;
        error?: string;
    };
    /**
     ...
     */
    static generatePresignedPost(bucketType: StorageBucket, fileName: string, contentType: string, maxSizeBytes?: number): Promise<{
        url: string;
