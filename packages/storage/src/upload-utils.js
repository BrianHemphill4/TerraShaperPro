...
class UploadUtils {
    static storageService = new storage_service_1.StorageService();
    /**
    ...
    static async generateDirectUploadUrl(bucketType, fileName, contentType, expiresInMinutes = 15) {
        ...
        const uploadUrl = await this.storageService.generateUploadUrl(bucketType, fileName, contentType, expiresAt);
     ...
     */
    static async generatePresignedPost(bucketType, fileName, contentType, _maxSizeBytes = 10 * 1024 * 1024 // 10MB default
    ) {
        ...
        const uploadUrl = await this.storageService.generateUploadUrl(bucketType, fileName, contentType);
        return {
            url: uploadUrl,
            fields: {
