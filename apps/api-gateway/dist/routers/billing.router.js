...
exports.billingRouter = (0, trpc_1.router)({
    ...
    updateSubscription: trpc_1.protectedProcedure
        ...
        // Update subscription
        const subscription = await subscriptionService.updateSubscription(org.stripe_subscription_id, {
            priceId: input.priceId,
    ...
    cancelSubscription: trpc_1.protectedProcedure
        ...
        // Cancel subscription
        const subscription = await subscriptionService.cancelSubscription(org.stripe_subscription_id, {
    ...
    getPaymentMethods: trpc_1.protectedProcedure.query(async ({ ctx }) => {
        ...
        return paymentMethods.map((pm) => ({
            ...
            isDefault: dbPaymentMethods?.find((db) => db.stripe_payment_method_id === pm.id)?.is_default ||
                false,
        }));
    }),
    // Add payment method
    addPaymentMethod: trpc_1.protectedProcedure
        ...
        const paymentMethod = await customerService.attachPaymentMethod(org.stripe_customer_id, input.paymentMethodId);
        // Save to database
