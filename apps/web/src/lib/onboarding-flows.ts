    ...
    steps: [
      {
        ...
        description: 'The professional landscape design tool built for Texas. Let\'s take a quick tour to get you started.',
        placement: 'center',
        action: {
          label: 'Get Started',
        },
      ...
      },
      {
        ...
        description: 'This is your home base. Here you can manage projects, view recent activity, and access all features.',
    ...
    steps: [
      {
        id: 'projects-section',
        title: 'Your Projects',
        description: 'All your landscape designs are organized here. You can search, filter, and manage them easily.',
    ...
    steps: [
      {
        ...
        description: 'This is where you\'ll create your landscape designs. Let\'s explore the tools available.',
      ...
      },
      {
        id: 'save-work',
        title: 'Auto-Save',
        description: 'Your work is automatically saved every few seconds. You can also save manually here.',
    ...
    steps: [
      {
        ...
        description: 'Create closed shapes like garden beds. Click to add points, double-click to finish.',
      ...
      },
      {
        id: 'area-tool',
        title: 'Area Tool (A)',
        description: 'Draw areas with materials like grass, mulch, or gravel. Select a material after drawing.',
