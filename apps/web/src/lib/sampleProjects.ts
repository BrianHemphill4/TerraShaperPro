...
export const sampleProjects: SampleProject[] = [
  {
    ...
    name: 'Backyard Oasis',
    description:
      'Transform your backyard into a relaxing retreat with native Texas plants and a small patio area.',
  ...
  },
  {
    ...
    description:
      'Create a water-wise front yard using drought-tolerant Texas native plants and decorative gravel.',
  ...
  },
  {
    ...
    description:
      'Design a welcoming commercial property entrance with structured planting beds and walkways.',
...
export function getSampleProjectsByDifficulty(
